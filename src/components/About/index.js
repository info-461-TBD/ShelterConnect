	...
	render() {
		return (
			<div className={classnames("About", this.props.className)}>
				...
				<h1>The Problem</h1>
				<p>Homelessness is a serious issue all across America. In a recent study, it was found that over half a million people are considered homeless in the United States. There are over 11,000 people that are homeless in Seattle alone, 47.1% of which are suffering without shelter. We know that there are several organizations in our city that are working towards ending homelessness once and for all, but the issue will not disappear overnight. No matter how noble their mission may be, they still need help.</p>
				<h1>Our Solution</h1>
