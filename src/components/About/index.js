				...
				<section id="testimonials">
					<div class="container">
						<div class="testimonial">
							<img src={Joseph} alt="profile photo" class="profile-img"/>
								<h2>Joseph Zhang <span class="occupation">Developer</span></h2>
								
                		</div>
						<div class="testimonial">
							<img src={Ryker} alt="profile photo" class="profile-img"/>
								<h2>Ryker Schwartzenberger <span class="occupation">Developer</span></h2>
		                </div>
						<div class="testimonial">
							<img src={Simon} alt="profile photo" class="profile-img"/>
								<h2>Simon Bang <span class="occupation">Developer</span></h2>
		                </div>
						<div class="testimonial">
							<img src={Sunwoo }alt="profile photo" class="profile-img"/>
								<h2>Sunwoo Kang <span class="occupation">Project Manager</span></h2>
		                </div>
					</div>
		        </section>
